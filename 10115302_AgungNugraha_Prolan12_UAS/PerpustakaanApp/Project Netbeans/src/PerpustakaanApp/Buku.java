...
public class Buku extends Pegawai {
    ...
    Buku(){
       ...
       // boolean meminjam,kons;
    	...
    	public void waktu()
        {
            System.out.println(" Maksimal peminjaman buku selama 3 hari ! ");    
        ...
        public void sanksi()
        {
            System.out.print(" Apakah anda siap menerima konsekuensinya ? [Y/T] : ");
               // kons = input1.nextBoolean();
               kons = input1.next().charAt(0);
            if(kons == 'Y' || kons == 'y')
            {
