...
import DataPepustakaanApp.DataPegawai;
import DataPepustakaanApp.DataBuku;
import DataPepustakaanApp.Aturan;
...
public class MenuPilihan {
    ...
    PengembalianBuku letBook = new PengembalianBuku();
    ...
    public void menu(){
        ...
        System.out.println("5. Atutan Peminjaman");
