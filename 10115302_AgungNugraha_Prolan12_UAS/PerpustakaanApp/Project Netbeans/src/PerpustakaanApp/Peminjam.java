...
//construkctor             
    Peminjam() {
		...
		//for encaptulation
		public static int tglPinjam,tglKembali;
		...
		public void jadi()
		{
				System.out.print(" Apakah Anda Ingin Meminjam Buku Ini ? [Y/T] : ");
					//super pada atribut
					super.meminjam = input1.next().charAt(0);

				if(meminjam == 'Y' || meminjam == 'y')
				{
